...
public class ChatEvents {
	...
	{
		String s = IChatComponent.Serializer.func_150696_a(event.message);		
		...
		if (!abort)
		{			
			IChatComponent st = IChatComponent.Serializer.func_150699_a(s);
			Minecraft.getMinecraft().ingameGUI.getChatGUI().printChatMessage(st);
		}
	}
